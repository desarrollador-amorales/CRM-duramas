 <!-- BEGIN SIDEBAR -->
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      ...
      <!-- END MINI-PROFILE -->
      <!-- BEGIN SIDEBAR MENU -->
      <p class="menu-title"><span class="pull-right"><a href="javascript:;" class="reload"><i class=""></i></a></span></p>
   
    <ul>	
      <li class="start"> <a href="dashboard.php"> <i class="icon-custom-home"></i> <span class="title">Escritorio</span> <span class="selected"></span>  </a> 
		    </li>
