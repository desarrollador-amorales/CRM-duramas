...
if($_REQUEST['action'] == 'fetch_factura_lead'){
    ...
    if((!empty($number_factura) || $number_factura!= "") && (!empty($value_factura) || $value_factura!= "") && (!empty($description) || $description!= "") ){
        mysqli_query($con,"insert into history_lead_factura (tracking_lead_id,user_name,number_factura, value_factura, description) values('$tracking_lead_id_gen','$user_name','$number_factura','$value_factura','$description')");
    ...
    $columns = ' date_create, user_name, number_factura, value_factura, description';
