...
{
    $sql=mysqli_query($con,"SELECT password FROM  supervisor where password='".$_POST['oldpass']."' && email='".$_SESSION['login']."'");
    $num=mysqli_fetch_array($sql);
    if($num>0)
    {
        $con=mysqli_query($con,"update supervisor set password='".$_POST['newpass']."' where email='".$_SESSION['login']."'");
