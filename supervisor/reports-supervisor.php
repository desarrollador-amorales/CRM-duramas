...
<head>
    ...
    <meta charset="utf-8" />
    <title>Supervisor | Reportes </title>
...
<body class="">
                ...
                <div class="span12">
                    <div class="grid simple ">
                        <div class="grid-title">
                            <h4><span class="semi-bold">Reporte de Usuario por Local</span></h4>
                            <div class="tools">
                            ...
                            <div class="row well input-daterange">
                                    <div class="col-sm-2">
                                        ...
                                        <input class="form-control datepicker" type="text"
                                            name="initial_date_user_warehouse" id="initial_date_user_warehouse"
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input class="form-control datepicker" type="text"
                                            name="final_date_user_warehouse" id="final_date_user_warehouse"
                                    ...
                                    <div class="col-sm-2">
                                        <button class="btn btn-info btn-xs" type="submit" name="filter-user-warehouse"
                                            id="filter-user-warehouse" style="margin-top: 25px" data-toggle="tooltip"
    ...
    function load_data_user_warehouse(initial_date, final_date) {
        var ajax_url = "jquery-ajax-sellers-supervisor.php";
