                    ...
                    <div class="grid simple ">
                        ...
                        <div class="grid-body ">
                            ...
                            <table id="example-date" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    <?php $ret=mysqli_query($con,"select tl.* from tracking_lead tl, user_supervisor_warehouse usw where usw.name_warehouse =tl.city_warehouse and usw.id_user_supervisor='".$id_supervisor."' and tl.status_name ='".$title."'");
