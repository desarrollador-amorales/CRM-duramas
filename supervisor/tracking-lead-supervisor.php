...
<body class="">
    ...
    <div class="page-content">
        ...
        <div class="clearfix"></div>
        <div class="content">
            <div class="page-title"> <i><a href="dashboard-supervisor.php" class="icon-custom-left"></a></i>
                        ...
                        <div class="grid-body ">
                            ...
                            <table id="example-date" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
                                     if ($title == 'General'){
                                        $ret=mysqli_query($con, "select tl.* from tracking_lead tl, user_supervisor_warehouse usw where usw.name_warehouse =tl.city_warehouse and usw.id_user_supervisor='".$id_supervisor."'");
                                     }else{
                                         $ret=mysqli_query($con, "select tl.* from tracking_lead tl, user_supervisor_warehouse usw where usw.name_warehouse =tl.city_warehouse and usw.id_user_supervisor='".$id_supervisor."' and tl.status_name ='".$title."'");
                                     }                             
												$cnt=1;
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="user_name" id="user_name"
                                                                    value="<?php echo $_SESSION['name_supervisor'];?>" readonly="">
                                                        ...
                                                        <div class="col-12 text-center">
                                                            <div class="row">
                                                                <div class="col-12 col-sm-6 text-center">
                                                                    ...
                                                                    <input type="hidden" name="user_name" id="user_name"
                                                                        value="<?php echo $_SESSION['name_supervisor'];?>"
                                                                        readonly="">
