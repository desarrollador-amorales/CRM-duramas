...
if(isset($_POST['login']))
{
    ...
    while ($user= mysqli_fetch_array($list_users)) {
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_POSTFIELDS => "token=m74gevw9ty4msvwi&to=".$number."&image=https://www.duramas.com.ec/wp-content/uploads/2022/11/black-days.jpeg&caption=‼*LLEGARON LOS #Blackdays DE LOCURA EN DURAMAS!* ‼\n\n‼*No dejes pasar esta oportunidad* ‼\n\nVen este *JUEVES 24- VIERNES 25 Y SÁBADO 26* de Noviembre \n\nA nuestras tiendas a *NIVEL NACIONAL* y ¡Obtén grandes *DESCUENTOS* en tus compras!\n\n *37% de DESCUENTO*- EN TODA LA TIENDA - Pagos en Efectivo 💵\n\n*27% de DESCUENTO* a pago corriente o 3 y 6 meses sin intereses con tu tarjeta de crédito Preferida  💳\n\nTE OFRECEMOS LOS MEJORES PRODUCTOS IMPORTADOS EN ACABADOS DE LA CONSTRUCCIÓN:\nPromociones en líneas de:\n\n*Porcelanatos, Cerámicas, Pisos Laminados, Granitos, Mármoles, Travertinos, Cuarcitas, Superficies de Cuarzo y más…*\n\nRecuerda que DURAMAS, es innovación, elegancia y calidad\n\n*Visítanos también en nuestra página web*\nwww.duramas.com.ec \n\n*¿Necesitas asesoría?* Déjanos tus datos aquí ⬇️\n\nhttp://crm.duramas.com.ec/rrss/\n\n Visítanos: Quito – Guayaquil – Cuenca – Ambato 📍\n\nRealizamos Despachos a nivel nacional🚚\n*Aplica restricciones*&referenceId={REFERENCEID}",

          CURLOPT_POSTFIELDS => "token=m74gevw9ty4msvwi&to=".$number."&image=https://www.duramas.com.ec/wp-content/uploads/2022/12/SORTEO-1.jpeg&caption=*¡PREMIAMOS TUS COMPRAS!*🥳 Y *¡CELEBRAMOS DICIEMBRE!* 👏🏻🎉\n\n‼Por compras superiores a *$1000*, participas en el sorteo de una espectacular cama importada con diseño italiano.*‼\n\nDifiere tus compras a 3-6-9-12 meses sin intereses 💳 *PAGA DESDE FEBRERO* ¡2 meses de gracia! con tarjetas seleccionadas. 🎉🎉\n\nCon *PAGOS EN EFECTIVO* obtén el 25% de descuento y adicional una *RASPADITA NAVIDEÑA* 🎄\n\nParticipan todas nuestras línea de: *Porcelanatos, Cerámicas, Pisos Laminados, Granitos, Mármoles, Travertinos, Cuarcitas, Superficies de Cuarzo y más…*\n\n¿Necesitas cotizar?\n*http://crm.duramas.com.ec/rrss/*\n\n Visítanos: Quito – Guayaquil – Cuenca – Ambato 📍\nRealizamos Despachos a nivel nacional🚚\n*Aplica restricciones*&referenceId={REFERENCEID}",
...
<body class="main-bg">
    <div class="login-container text-c animate__animated animate__flipInX">
        ...
        <div class="container-content">
            ...
            <p class="margin-t text-whitesmoke"><small> Sistemas Duramas &copy; 2022</small> </p>
        </div>
    </div>
