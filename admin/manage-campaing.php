                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel"><b>Campaña</b></h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="" class="control-label"><b>Descripcion:</b></label>
                ...
                <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <h4>Listo!</h4>
                            <br>
                            <p>La campaña se ha registrado correctamente.</p>
                        ...
                        <div class="col-md-12">
                            <div class="grid simple ">
                                ...
                                <div class="grid-body no-border">
                                    ...
                                    <table id = "manage-campaing" class="table table-hover table-condensed">
