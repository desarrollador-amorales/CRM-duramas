...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin | Supervisores</title>
                                    ...
                                    <table id="manage-users-admin" class="table table-hover table-condensed">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:30%"><label class="control-label"><b>Ciudad</b></label></th>
                                                <th><label class=" control-label"><b>Accion</b></label></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $ret=mysqli_query($con,"select * from supervisor order by supervisor_id_gen");
												$cnt=1;
												while($row=mysqli_fetch_array($ret))
												{
													$_SESSION['ids']=$row['supervisor_id_gen'];
												?>
                                            <tr>
                                                <td><?php echo $cnt;?></td>
                                                ...
                                                <td>
                                                    <form name="abc" action="" method="post">
                                                        ...
                                                        <button type="button" class="btn btn-info btn-xs"
                                                            ...
                                                            onclick="location.href='edit-user-super.php?id=<?php echo $row['supervisor_id_gen'];?>'"><i
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-xs"
                                                            ...
                                                            onclick="location.href='delete-user-super.php?id=<?php echo $row['supervisor_id_gen'];?>'"><i
                                                        ...
                                                        <button type="button" class="btn btn-warning btn-xs"
                                                            ...
                                                            onclick="location.href='send-user-credentials.php?rol=Supervisor&email=<?php echo $row['email'];?>'"><i
