			  ...
			  {?>
                ...
                <form name="muser" method="post" action="" enctype="multipart/form-data">
                    ...
                    <table width="50%" border="0">
                        ...
                        <tr>
                            <td height="42"><label class="control-label"><b>Orden</b></label></td>
                            <td><input type="number" name="order_status" id="order_status" value="<?php echo $rw['order_status'];?>"
                                    class="form-control"></td>
                        </tr>
                        <tr>
                            <td height="42"><label class="control-label"><b>Estado</b></label></td>
            ...
            <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <h4>Listo!</h4>
                            <br>
                            <p>El estado se actualizo correctamente.</p>
