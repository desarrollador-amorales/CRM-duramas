...
if($_REQUEST['action'] == 'fetch_campaing_warehouse'){
	...
	$sql.=" ( ";
        $sql.=" SELECT ";
		$sql.=" tl.city_warehouse , (SELECT c2.description from campaing c2 where c2.name= tl.form_id) as campania, ( ";
            $sql.=" SELECT ";
			$sql.=" COUNT(*) ";
            $sql.=" FROM ";
			$sql.=" tracking_lead tl2 ";
            $sql.=" where ";
			$sql.=" tl.form_id = tl2.form_id ";
			...
			$sql.=" AND tl2.status_name = 'Solicitud' ) as Solicitud , ( ";
                ...
                $sql.=" AND tl2.status_name = 'Seguimiento' ) as Seguimiento, ( ";
                    ...
                    $sql.=" AND tl2.status_name = 'Concretado' ) as Concretado, ( ";
                        ...
                        $sql.=" FROM ";
                        $sql.=" tracking_lead tl WHERE tl.date_create BETWEEN '".$initial_date."' AND '".$final_date."' ";
                        ...
                        $sql.=" group by ";
                        $sql.=" campania , tl.city_warehouse ";
                        $sql.=" order by ";
