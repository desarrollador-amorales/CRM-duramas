    ...
    var r = function(n) {
        ...
        TableTools.prototype = {
            ...
            fnResizeRequired: function() {
                for (var a in g.clients)
                    if (a) { var b = g.clients[a]; if ("undefined" != typeof b.domElement && b.domElement.parentNode == this.dom.container && !1 === b.sized) return !0 }
                return !1
            },
            ...
            _fnTextConfig: function(a, b) {
                ...
                e(a).hover(function() { b.fnMouseover !== null && b.fnMouseover.call(this, a, b, null) }, function() { b.fnMouseout !== null && b.fnMouseout.call(this, a, b, null) });
            ...
            _fnColumnTargets: function(a) {
                ...
                } else if ("visible" == a) { d = 0; for (f = c.aoColumns.length; d < f; d++) b.push(c.aoColumns[d].bVisible ? !0 : !1) } else if ("hidden" == a) {
                    d = 0;
                    for (f = c.aoColumns.length; d <
                        f; d++) b.push(c.aoColumns[d].bVisible ? !1 : !0)
                } else if ("sortable" == a) { d = 0; for (f = c.aoColumns.length; d < f; d++) b.push(c.aoColumns[d].bSortable ? !0 : !1) } else { d = 0; for (f = c.aoColumns.length; d < f; d++) b.push(!0) }
                return b
            },
            ...
            _fnGetDataTablesData: function(a) {
                ...
                var p = this.fnGetSelected(),
                    ...
                    q = g.oInstance.$("tr", a.oSelectorOpts).map(function(a, b) { return n && -1 === e.inArray(b, p) ? null : g.oInstance.fnGetPosition(b) }).get();
                d = 0;
            ...
            _fnChunkData: function(a,
                b) { for (var c = [], d = a.length, f = 0; f < d; f += b) f + b < d ? c.push(a.substring(f, f + b)) : c.push(a.substring(f, d)); return c },
            ...
            _fnPrintStart: function(a) {
                ...
                for (f in d)
                    if ("i" != f && "t" != f && 1 == f.length)
                        for (var i = 0, g = d[f].length; i < g; i++) this.dom.print.hidden.push({ node: d[f][i], display: "block" }), d[f][i].style.display = "none";
        ...
        TableTools.BUTTONS = {
            ...
            print: e.extend({},
                TableTools.buttonBase, { sInfo: "<h6>Print view</h6><p>Please use your browser's print function to print this table. Press escape when finished.</p>", sMessage: null, bShowAll: !0, sToolTip: "View print view", sButtonClass: "DTTT_button_print", sButtonText: "Print", fnClick: function(a, b) { this.fnPrint(!0, b) } }),
